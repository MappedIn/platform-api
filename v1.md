...
*Note:* This JSON API is useful for testing and examining the data that is available for your Venue, but for a production application you should be using the [Mappedin Web SDK](../..).
