...
*Note:* This JSON API is useful for testing and examining the data that is available for your Venue, but for a production application you should be using the [Mappedin Web SDK](README.MD).
...
The MappedIn JSON API is an interface to the MappedIn backend for venue management and indoor wayfinding. Using this API directly in a production enviroment is *NOT SUPPORTED*, use the SDK.
