...
### Current Version
The current version of the Mappedin Web SDK is v1.63.0, and can be included in your application via script tag, like so:

```xml
<script src="https://d1p5cqqchvbqmy.cloudfront.net/websdk/v1.63.0/mappedin.js"></script>
```
